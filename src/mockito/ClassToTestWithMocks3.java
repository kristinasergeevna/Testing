...
public class ClassToTestWithMocks3 {
    ...
    public void sendPayment(final Account from, final Account to, final int
            amount) throws
            Exception {
        this.paymentDAO.transferPayment(from, to, amount);
        this.paymentDAO.updateAccounts(from, to, amount);
    ...
    public void setPaymentDAOImpl(final PaymentDAO paymentDAO) {
    ...
    private void validateSite() throws IOException {
        HttpURLConnection connection = (HttpURLConnection) new URL
                ("http://googlemeowkris.com").openConnection();
    ...
    public static void main(final String[] args) throws Exception {
        ...
        paymentService.setPaymentDAOImpl(new PaymentDAOImpl());
